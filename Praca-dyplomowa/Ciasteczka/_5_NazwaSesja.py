...
class _5_NazwaSesja(unittest.TestCase):
    ...
    def test_zapisanie_usuniecie_zmiana_sesji_zaladowanie_ciasteczek(self):
        """
            Zapisanie, usunięcie, zmiana nazwy ciasteczka sesji i załadowanie wyedytowanch ciasteczek do aplikacji.
        """
        print u"\n---ZAPISANIE, USUNIĘCIE, ZMIANA NAZWY CIASTECZKA SESJI I ZAŁADOWANIE CIASTECZEK DO APLIKACJI---"
        
        # Zalogowanie Admina
        self.login()
        
        # Zapisanie, usunięcie, zmiana nazwy ciasteczka sesji i załadowanie wyedytowanch ciasteczek do aplikacji.
        self.zapisz_usun_zmien_sesje_zaladuj_ciasteczka()
    ...
    def zapisz_usun_zmien_sesje_zaladuj_ciasteczka(self):
        """
            Zapisanie, usunięcie, zmiana nazwy ciasteczka sesji i załadowanie wyedytowanch ciasteczek do aplikacji.
        """
        driver = self.driver
        ...
        try:
            print "Edycja ciasteczek (zmiana nazwy ciasteczka sesji) w pliku tymczasowym"
            ...
            # Zamiana właściwej nazwy ciasteczka sesji na niepoprawną
            ...
            for line in plik_wejsciowy:
                plik_tymczasowy.write(line.replace("VSIDMRBUGGYFR", "VNiepoprawna_nazwa"))
    ...
    def zrzut_ekranu(self):
        """
            Wykonanie zrzutu ekranu i zapisanie go do pliku PNG w podkatalogu "\NazwaSesja".
        """
        print "Zapis zrzutu ekranu do pliku PNG"
        _5_NazwaSesja.licznik += 1 # Kolejne pliki ze zrzutami ekranu mają numerację zwiększaną o "1".
        if not os.path.exists(os.getcwd() + "\\NazwaSesja"):
            os.mkdir(os.getcwd() + "\\NazwaSesja") # Utworzenie katalogu "\NazwaSesja".
        self.sciezka_pliku_zrzut = os.getcwd() + "\\NazwaSesja" + "\\NazwaSesja{0}.png".format(_5_NazwaSesja.licznik)
